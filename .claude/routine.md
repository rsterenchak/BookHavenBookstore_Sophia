...
This file documents the project-specific commands, conventions, and quirks for **BookHavenBookstore_Sophia**. It supplements `routine-base.md` (which has the universal discipline) with project-specific details Claude runs need to know.
...
**Name:** BookHavenBookstore_Sophia
...
>
> - "BookHavenBookstore_Sophia is a single-page app; routing is hash-based via {{ROUTER_FILE}}."

...
**Files to fill in:**
- [ ] Replace `BookHavenBookstore_Sophia` everywhere in this file with this project's name (the repo name is usually fine: e.g. `my-app`, `react-thing`, `cool-project`).
...
**Project name:** BookHavenBookstore_Sophia
